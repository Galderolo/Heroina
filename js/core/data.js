// Datos base y utilidades puras del juego (ES Module)
...
export const CLASSES = [
  {
    ...
    icon: '🛡️',
    stats: { lives: 8, maxLives: 8, energy: 5, maxEnergy: 5 },
  },
  {
    id: 'ranger',
    name: 'Ranger',
    ...
    icon: '🏹',
    stats: { lives: 5, maxLives: 5, energy: 8, maxEnergy: 8 },
  },
  {
    id: 'mage',
    name: 'Mago',
    ...
    icon: '🔮',
    stats: { lives: 6, maxLives: 6, energy: 6, maxEnergy: 6 },
  },
  {
    id: 'warrior',
    name: 'Guerrero',
    ...
    icon: '⚔️',
    stats: { lives: 7, maxLives: 7, energy: 5, maxEnergy: 5 },
  },
];
...
export function getUnlockedRewards(level, rewards = REWARDS) {
  return rewards.filter((r) => r.requiredLevel <= level);
}

export function getStandardMissionValues(type) {
  const values = {
    diaria: { xp: 3, gold: 20 },
    ayuda: { xp: 5, gold: 30 },
    epica: { xp: 12, gold: 75 },
...
export function getStandardRewardPrice(category) {
  const prices = {
    pequeña: 60,
    media: 220,
    grande: 400,
...
export function getAllMissions(customMissions = []) {
  const extra = Array.isArray(customMissions) ? customMissions : [];
  return [...MISSIONS, ...extra];
}

export function getAllRewards(customRewards = []) {
  const extra = Array.isArray(customRewards) ? customRewards : [];
